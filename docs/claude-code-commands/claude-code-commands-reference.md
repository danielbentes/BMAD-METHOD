...
> **Generated:** 2025-06-04 12:10:58 UTC
...
**Parameters:**
- `persona` (string, Required): Target persona (values: analyst, pm, architect, dev, sm, po, quality, design-architect)
...
**Aliases:** h, {None: None}, help-me, assist
...
##### `context`
**Description:** Display rich context with memory insights and suggestions
...
- `memory` (boolean, Optional): Include memory insights (default: True)
- `suggestions` (boolean, Optional): Show next step suggestions (default: True)
...
**Last Updated:** 2025-06-04 12:10:58 UTC  
**Source:** bmad-agent/commands/command-registry.yml  
**Command Count:** 46 total commands across 9 groups
