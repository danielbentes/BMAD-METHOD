...
To generate a masterful, comprehensive, and optimized prompt that can be used with AI-driven frontend development tools (e.g., Lovable, Vercel v0, or similar) to scaffold or generate significant portions of the frontend application. Store the generated prompt at `.bmad/guidance/prompts/frontend-generation-{tool}-{date}.md`.

## Inputs

- Completed UI/UX Specification (`.bmad/current/specs/frontend-spec.md`)
- Completed Frontend Architecture Document (`.bmad/current/specs/frontend-architecture.md`)
- Main System Architecture Document (`.bmad/current/specs/architecture.md` - for API contracts and tech stack)
...
3.  **Present and Refine the Master Prompt:**
    - Output the generated prompt in a clear, copy-pasteable format and save it to `.bmad/guidance/prompts/frontend-generation-{tool}-{date}.md`.
