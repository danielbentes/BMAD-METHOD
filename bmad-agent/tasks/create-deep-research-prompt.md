...
- Store deep research prompts and findings at `.bmad/guidance/prompts/deep-research-{topic}-{date}.md` and research results at `.bmad/current/analysis/research-{topic}-{date}.md`.
...
4.  **Synthesize & Present Findings:**
    ...
    - Save comprehensive research findings at `.bmad/current/analysis/research-{topic}-{date}.md`.
5.  **Discussing and Utilizing Research Output:**
    ...
    - **Research Storage**: All findings are saved at `.bmad/current/analysis/research-{topic}-{date}.md` for future reference and PRD input.
...
6.  **Confirm Readiness for PRD Generation:**
    ...
    - Ensure all research artifacts are properly stored at `.bmad/current/analysis/` for PRD task input.
